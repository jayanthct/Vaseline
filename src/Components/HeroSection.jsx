...
function HeroSection() {
    ...
    const imageStyles = [
        {
            width: '32%', height: 'auto', top: '-12px',
            left: '36%',filter: 'brightness(1.1)'

        },
        {
            width: '32%', height: 'auto', top: '0',
            left: '36%', filter: 'brightness(1.1)'
        },
        {
            width: '32%', height: 'auto', top: '-12px',
        ...
        <>
            <section className="hero bg-white relative px-[10%] pb-[2%] mt-[8%] w-full h-screen flex flex-col justify-around items-center">
                ...
                <div className="flex flex-col items-center">
                    ...
                    >
                        <span className="font-italianno text-[120px] text-primary">Vaseline</span>
                        <span
                            className="text-[102px]"
                            style={{
                    ...
                    <div
                        className="text-[102px] text-center"
                        style={{
                            background: 'linear-gradient(40deg, #2D9EF7, #89CBFF)',
                            WebkitBackgroundClip: 'text',
                            WebkitTextFillColor: 'transparent',
                            alignSelf: 'center',
                            marginBottom: '-40px' // Adjust for overlap with the next line
                        }}
                    >
                        Skin Enhance
                    </div>
                    ...
                    >
                        ...
                        <span className="text-[120px] font-italianno text-primary">Miracle</span>
                    </div>
                </div>
                ...
                <button onClick={prevSlide} className="navbutton flex justify-center items-center bg-[#eeeeee] rounded-full px-[18px] py-[18px] absolute top-[220px] left-[120px]">
                    <img src={chevron} alt="previous" className="rotate-180" />
                </button>
                <button onClick={nextSlide} className="navbutton flex justify-center items-center bg-[#eeeeee] rounded-full px-[18px] py-[18px] absolute top-[220px] right-[120px]">
